...
import { FERRY_ROUTE_IDS, ROUTE_DEFINITIONS } from "./config";
import { formatClockLabel, parseScheduleEntries } from "./time";
...
function inferHubTravelMinutes(routeId: OperationalRouteId) {
  if (routeId === "dragon-line") return 12;
  if (routeId === "rawai-airport") return 15;
  if (routeId === "patong-old-bus-station") return 18;
  return null;
}
