...
function buildTimetableStop(
  ...
  return {
    ...
    routeId,
    sequence: seq,
    name: { en: tStop.name, th: tStop.name_th, zh: tStop.name, ko: tStop.name, de: tStop.name, fr: tStop.name, es: tStop.name },
    direction: { en: directionLabel, th: directionLabel, zh: directionLabel, ko: directionLabel, de: directionLabel, fr: directionLabel, es: directionLabel },
    routeDirection: { en: directionLabel, th: directionLabel, zh: directionLabel, ko: directionLabel, de: directionLabel, fr: directionLabel, es: directionLabel },
    coordinates: [tStop.lat, tStop.lng] as LatLngTuple,
    scheduleText: "",
    nextBus: { label: "", minutesUntil: null, basis: "fallback", notes: { en: "", th: "", zh: "", ko: "", de: "", fr: "", es: "" } },
    timetable: { firstDepartureLabel: null, lastDepartureLabel: null, nextDepartures: [], serviceWindowLabel: null, sourceLabel: { en: "", th: "", zh: "", ko: "", de: "", fr: "", es: "" }, sourceUrl: "", sourceUpdatedAt: null, notes: { en: "", th: "", zh: "", ko: "", de: "", fr: "", es: "" } },
...
function buildOrangeLineVehicles(nowMin: number, now: Date): VehiclePosition[] {
  ...
  return active.slice(0, orangeBuses.length).map((trip) => {
    ...
    return {
      ...
      deviceId: null,
      coordinates, heading, speedKph,
      destination: { en: trip.dir, th: trip.dir === "Airport to Town" ? "สนามบิน→เมือง" : "เมือง→สนามบิน", zh: trip.dir, ko: trip.dir === "Airport to Town" ? "공항→시내" : "시내→공항", de: trip.dir, fr: trip.dir, es: trip.dir },
      updatedAt: nowIso,
